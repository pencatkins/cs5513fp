...
// set endpoint
const dataLoc = "https://dev-cs5513f.pantheonsite.io/wp-json/twentytwentyone-child/v1/recipe-list";
...
export async function getInfo3() {
  ...
  for (y=0; y<jsonArrObj.length; y++) {
    (jsonArrObj[y].post_content).replaceAll("\r\n' + ' \t","");
    console.log(jsonArrObj[y].post_content);
  }
  console.log("333333333");
//  console.log(a);
  console.log(jsonArrObj);
  console.log("444444444");
  console.log(jsonArrObj[0].post_content);
...
export async function getFavoriteData(idSelected) {
  ...
  for (y=0; y<jsonObj.length; y++) {
    (jsonObj[y].post_content).replaceAll("\r\n' + ' \t","");
    console.log(jsonObj[y].post_content);
  }
